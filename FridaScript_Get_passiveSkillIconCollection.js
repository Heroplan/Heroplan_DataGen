CAAC,MAAM,EAAE,CAAC,EAAE,EAAE;oBACnC,mCAAmC;oBACnC,MAAM,GAAG,GAAI,SAAS,CAAC,GAAG,CAAC,CAAC,CAAmB,CAAC,OAAO,CAAC;oBAExD,mBAAmB;oBACnB,IAAI,CAAC,GAAG,EAAE;wBACF,SAAS;qBAChB;oBAED,MAAM,WAAW,GAAG,WAAW,CAAC,GAAG,CAAC,CAAC,CAAkB,CAAC;oBACxD,IAAI,WAAW,CAAC,MAAM,CAAC,MAAM,EAAE;wBAAE,SAAS;oBAE1C,MAAM,UAAU,GAAG,WAAW,CAAC,KAAK,CAAgB,MAAM,CAAC,CAAC,KAAK,CAAC;oBAElE,IAAI,cAAc,GAAG,aAAa,CAAC;oBACnC,IAAI,CAAC,UAAU,CAAC,MAAM,CAAC,MAAM,EAAE,EAAE;wBACzB,sCAAsC;wBACtC,cAAc,GAAG,UAAU,CAAC,MAAM,CAAgB,UAAU,CAAC,CAAC,MAAM,EAAE,CAAC,OAAO,IAAI,aAAa,CAAC;qBACvG;oBAED,mBAAmB;oBACnB,OAAO,CAAC,GAAG,CAAC,GAAG,cAAc,CAAC;iBACrC;gBAED,kCAAkC;gBAClC,OAAO,CAAC,GAAG,CAAC,mBAAmB,CAAC,CAAC;gBACjC,OAAO,CAAC,GAAG,CAAC,IAAI,CAAC,SAAS,CAAC,OAAO,EAAE,IAAI,EAAE,CAAC,CAAC,CAAC,CAAC;gBAC9C,OAAO,CAAC,GAAG,CAAC,qBAAqB,CAAC,CAAC;gBAGnC,OAAO,CAAC,GAAG,CAAC,qCAAqC,CAAC,CAAC;aAE1D;YAAC,OAAO,CAAM,EAAE;gBACT,OAAO,CAAC,KAAK,CAAC,qDAAqD,EAAE,CAAC,CAAC,KAAK,CAAC,CAAC;aACrF;oBAAS;gBACF,gBAAgB;gBAChB,gBAAgB,GAAG,IAAI,CAAC;aAC/B;YAED,OAAO,mBAAmB,CAAC;QAEnC,CAAQ,CAAC;KAEhB;IAAC,OAAO,CAAM,EAAE;QACT,OAAO,CAAC,KAAK,CAAC,sCAAsC,EAAE,CAAC,CAAC,KAAK,CAAC,CAAC;KACtE;AACT,CAAC,CAAC,CAAC"}
✄
...
Il2Cpp.perform(() => {
    ...
    try {
        ...
        targetMethod.implementation = function () {
            ...
            const originalReturnValue = this.field("_passiveSkillIconCollection").value
                .method("get_Reference").invoke()
                .field("Data").value;
            if (hasBeenExtracted) {
            ...
            try {
                ...
                if (dataObject.handle.isNull())
                    return dataObject;
                const keysArray = dataObject.field("_keys").value;
                const valuesArray = dataObject.field("_values").value;
                ...
                for (let i = 0; i < keysArray.length; i++) {
                    ...
                    const key = keysArray.get(i).content;
                    // 【修正 3】: 添加类型安全检查
                    if (!key) {
                        continue;
                    }
                    const valueObject = valuesArray.get(i);
                    if (valueObject.handle.isNull())
                        continue;
                    const iconSprite = valueObject.field("Icon").value;
                    let iconIdentifier = "NULL_SPRITE";
                    if (!iconSprite.handle.isNull()) {
                        // 【修正 4】: 使用 .content 获取纯净的 Sprite 名字
                        iconIdentifier = iconSprite.method("get_name").invoke().content ?? "NULL_SPRITE";
                    }
                    // 【修正 5】: 将结果存入对象中
