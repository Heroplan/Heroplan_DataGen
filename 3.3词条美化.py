...
COMMOM_DICT_CONFIG = {
    ...
    '强化防御异常': '[#!]强化防御异常[#]',
    '强化防禦異常': '[#!]强化防禦異常[#]',
    'Enhanced Defense Ailment': '[#!]Enhanced Defense Ailment[#]',
    '粘性表面': '[#!]粘性表面[#]',
    '黏黏表面': '[#!]黏黏表面[#]',
    'Sticky Surface': '[#!]Sticky Surface[#]',
    '剧毒伤害': '[##elementpurple]剧毒伤害[#]',
    '劇毒傷害': '[##elementpurple]劇毒傷害[#]',
    'Poison damage': '[##elementpurple]Poison damage[#]',
    '腐蚀性毒伤': '[##elementpurple]腐蚀性毒伤[#]',
    ...
    '腐蚀性灼伤': '[##elementred]腐蚀性灼伤[#]',
    '腐蝕燒傷': '[##elementred]腐蝕燒傷[#]',
