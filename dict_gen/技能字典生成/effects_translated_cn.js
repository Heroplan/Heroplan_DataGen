const translatedEffectsCN =
    [
        ...
        },
        {
            ...
            "name": "Halcyon",
            "effects": [
                "摧毁目标的全部小兵，此效果会对超级小兵造成伤害。（此效果也适用于超级小兵，但只会对超级小兵造成相当于其最大生命值50 % 的伤害，而非将其摧毁。）",
                "对命中的目标造成 325% 伤害。",
                " 如果目标拥有小兵，则攻击另外一个拥有小兵的敌人。如果敌人都没有小兵，则攻击随机一名敌人。每名敌人只能被攻击一次。（此效果也适用于超级小兵，但只会对超级小兵造成相当于其最大生命值50 % 的伤害，而非将其摧毁。）",
