...
[
    ...
    },
    {
        ...
        "effects": [
            ...
            "All ailments affecting attack, defense and mana generation on the caster and nearby allies are replaced by matching undispellable buffs. (Replacing cannot be blocked by status effects and passive. Only status effects that are dispellable or cleansable can be replaced. Replacement effects: Attack ailments are replaced with +40% attack buff for 4 turns. Defense ailments are replaced with +40% defense buff for 4 turns. Mana generation ailments are replaced with +40% mana generation buff for 4 turns.)"
        ]
    },
    {
        "originalIndex": 582,
    ...
    },
    {
        ...
        "effects": [
            ...
            "All buffs affecting attack, defense and mana generation on all enemies are transformed into matching uncleansable ailments. (Transform cannot be blocked by status effects, family effects or passives. Only buff that are dispellable can be replaced. Transormed effects: Attack buffs are transformed into -40% attack status ailment for 4 turns. Defense buffs are transformed into -40% defense status ailment for 4 turns. Mana generation buffs are transformed into -40% mana generation status ailment for 4 turns.)"
        ]
    },
    {
        "originalIndex": 1529,
