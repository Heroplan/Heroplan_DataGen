...
[
    ...
    },
    {
        ...
        "effects": [
            "对目标造成 500% 伤害。",
            "目标在 6 回合内受到 1500 点奔涌流血伤害。（如果目标已拥有此效果，持续时间会被刷新，伤害增加 300 点。总伤害上限: 2400.）",
    ...
    },
    {
        ...
        "effects": [
            "对目标造成 565% 伤害，并对附近敌人造成轻微伤害。",
            "目标受到腐蚀性毒伤，持续 3 回合。腐蚀性毒伤每回合造成 134 点剧毒伤害，并且使目标的法力生成每回合降低 10%。对拥有小兵和超级小兵的英雄造成额外伤害。（仅影响通过消除方块生成的法力，或防御战队在回合结束获得的法力）",
    ...
    },
    {
        ...
        "effects": [
            "从目标处窃取所有小兵和超级小兵。",
            "对目标造成 850% 伤害。",
            "只要施法者拥有小兵或超级小兵，则所有敌人受到额外 +50% 的伤害。此效果无法驱散。",
            "影响所有敌人的攻击、防御和法力生成的所有增益将转换为对应的不可净化状态异常。（状态效果、家族效果和被动技能不能格挡转换。仅能转换可驱散的增益。转换效果:攻击增盖被转换为 -40% 的攻击状态异常，持续 4 回合。防御增益被转换为 -40% 的防御状态异常，持续 4 回合。法力生成增益被转换为 -40% 的法力生成状态异常，持续 4 回合。）"
        ]
    },
    {
        "originalIndex": 807,
    ...
    },
    {
        ...
        "effects": [
            ...
            "从目标及相邻敌人身上收割增益效果。（收割可以从每个目标身上安全移除 2 个增益效果、正面效果叠加和成长效果。包含不可驱散的增益效果和起舞效果。每移除一个效果，施法者的生命值提升 7%。提升的生命值可以超过最大生命值。安全移除会无视状态异常被移除时的次级效果，例如移除时造成伤害。被动技能和家族效果等外来效果仍会生效。成长效果会率先被移除，其他效果则按照“后施加的先移除”的规则处理。）",
    ...
    },
    {
        ...
        "effects": [
            "对 2 名随机敌人造成 500% 伤害。",
            "若本次攻击将敌人击败，那么施法者将恢复 +30% 生命并获得 +30% 法力。",
            "所有盟友以所受伤害的 +100% 进行反击，持续 4 回合。"
        ]
    },
    {
        "originalIndex": 1396,
    ...
    },
    {
        ...
        "name": "Ratgrub",
        "effects": [
            "召唤一个鼠公主超级小兵，其可从施法者处继承 35% 生命值和 160% 攻击力。",
            "鼠公主超级小兵被召唤后，可使其所有者在其他盟友施放特殊技能时对所有敌人造成 240% 伤害。（此效果每个角色每回合可触发一次。）"
        ]
    },
    {
        "originalIndex": 1468,
