...
[
    ...
    },
    {
        ...
        "name": "Sproutwhisker",
        "effects": [
            "荒野：在 4 回合内，所有盟友每回合恢复 400 点生命值或获得 800 点生命加成。（荒野效果每回合有几率变得更加强大。此荒野效果有 50% 的几率在本回合额外治疗 +100% 的生命值。当额外生命值被治疗时，该效果会提供加成生命值。荒野效果能够无视大多数通常会阻止其生效的效果荒野效果可与其他同类型效果叠加生效。）",
