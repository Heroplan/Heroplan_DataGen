...
[
    ...
    },
    {
        ...
        "name": "Hogne C1",
        "effects": [
            "使用霜降打击攻击目标和附近敌人，造成最多 2500 点伤害。若目标为火焰系元素，则额外造成 40% 伤害。该特殊技能必定命中。",
    ...
    },
    {
        ...
        "effects": [
            ...
            "所有冰雪系盟友在 4 回合内获得 +100% 普通攻击。（若附加效果提升整体攻击，普通攻击最多可提升 +200% 的战力。）",
            "拟态兽宝箱关闭 2 回合。（拟态兽宝箱关闭时免疫伤害和新的状态异常）"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            "对目标造成 480% 伤害。",
            "若本次攻击将敌人击败，那么施法者将恢复 +50% 生命并获得 +33% 法力。（在单个回合内，当一名角色已经从特殊技能获得了 5 次直接法力补充后，该角色此后再通过特殊技能获得的所有直接法力补充效果都会被削弱。）",
            "所有自然系盟友在 4 回合内获得 +100% 普通攻击。（若附加效果提升整体攻击，普通攻击最多可提升 +200% 的战力。）",
            "拟态兽宝箱关闭 2 回合。（拟态兽宝箱关闭时免疫伤害和新的状态异常）"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            "对目标造成 480% 伤害。",
            "若本次攻击将敌人击败，那么施法者将恢复 +50% 生命并获得 +33% 法力。（在单个回合内，当一名角色已经从特殊技能获得了 5 次直接法力补充后，该角色此后再通过特殊技能获得的所有直接法力补充效果都会被削弱。）",
            "所有暗黑系盟友在 2 回合内获得 +100% 普通攻击。（若附加效果提升整体攻击，普通攻击最多可提升 +200% 的战力。）",
            "拟态兽宝箱关闭 2 回合。（拟态兽宝箱关闭时免疫伤害和新的状态异常）"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            "对目标造成 480% 伤害。",
            "若本次攻击将敌人击败，那么施法者将恢复 +50% 生命并获得 +33% 法力。（在单个回合内，当一名角色已经从特殊技能获得了 5 次直接法力补充后，该角色此后再通过特殊技能获得的所有直接法力补充效果都会被削弱。）",
            "所有烈火系盟友在 4 回合内获得 +100% 普通攻击。（若附加效果提升整体攻击，普通攻击最多可提升 +200% 的战力。）",
            "拟态兽宝箱关闭 2 回合。（拟态兽宝箱关闭时免疫伤害和新的状态异常）"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            "对目标造成 480% 伤害。",
            "若本次攻击将敌人击败，那么施法者将恢复 +50% 生命并获得 +33% 法力。（在单个回合内，当一名角色已经从特殊技能获得了 5 次直接法力补充后，该角色此后再通过特殊技能获得的所有直接法力补充效果都会被削弱。）",
            "所有神圣系盟友在 4 回合内获得 +100% 普通攻击。（若附加效果提升整体攻击，普通攻击最多可提升 +200% 的战力。）",
            "拟态兽宝箱关闭 2 回合。（拟态兽宝箱关闭时免疫伤害和新的状态异常）"
        ]
    },
    {
