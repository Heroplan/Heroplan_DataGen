...
[
    ...
    },
    {
        ...
        "name": "Emilie",
        "effects": [
            "对目标释放完全移除。（完全移除可以移除目标的所有状态效果、叠加效果、成长效果和衰退效果。包含不可驱散或无法净化的状态效果和叠加效果。）",
            "目标转变为深渊幽灵形态，持续 5 回合。",
    ...
    },
    {
        ...
        "name": "Sable",
        "effects": [
            "对施放者释放完全移除（完全移除可以移除目标的所有状态效果、叠加效果、成长效果和衰退效果。包含不可驱散或无法净化的状态效果和叠加效果）。",
    ...
    },
    {
        ...
        "effects": [
            "移除全体敌人的所有状态效果，包括不可驱散或无法净化的状态效果。",
    ...
    },
    {
        ...
        "name": "Morris",
        "effects": [
            "移除施法者的所有状态效果和叠加效果，包含不可驱散或无法净化的状态效果和叠加效果。",
            "施法者挖个洞藏进去，持续 2 回合。",
    ...
    },
    {
        ...
        "name": "Morris C1",
        "effects": [
            "移除施法者的所有状态效果和叠加效果，包括那些不可驱散或无法净化的状态效果和叠加效果。",
            "施法者挖个洞藏进去，持续 3 回合。",
    ...
    },
    {
        ...
        "effects": [
            "此特殊技能有几率造成暴击。（造成暴击的几率取决于英雄在造成伤害时的总暴击几率。此特殊技能造成的暴击会额外造成 50% 伤害。暴击可以减少PvP战斗中敌人的最大生命值。此效果对拥有生命加成的目标更强）",
            "对目标造成 420% 伤害。",
            "对施放者释放完全移除。完全移除可以移除目标的所有状态效果、叠加效果、成长效果和衰退效果。（完全移除可以移除目标的所有状态效果、叠加效果、成长效果和衰退效果。包含不可驱散或无法净化的状态效果和叠加效果）",
            "施法者转变为幽灵形态，持续 2 回合。",
            "当幽灵形态结束时：",
    ...
    },
    {
        ...
        "effects": [
            "移除施法者以外所有盟友的状态效果，包含不可驱散或无法净化的状态效果。",
    ...
    },
    {
        ...
        "effects": [
            "移除所有盟友（除施法者外）的状态效果。包含不可驱散或无法净化的状态效果。",
            "为所有盟友恢复 48% 生命值。",
            "除施法者外的所有盟友跳起英灵之舞，持续 4 回合：",
            "* +110% 攻击力。",
            "* 所受的所有伤害减少 -30%。",
    ...
    },
    {
        ...
        "effects": [
            ...
            "若猫头鹰武神小兵被击败，对攻击者释放完全移除。（完全移除可以移除目标的所有状态效果、叠加效果、成长效果和衰退效果。包含不可驱散或无法净化的状态效果和叠加效果）",
