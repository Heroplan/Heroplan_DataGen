...
[
    ...
    },
    {
        ...
        "effects": [
            "对目标造成 600% 伤害。",
            "友军拥有多少个超级小兵和小兵，就随机对同样数量的敌人造成额外 130% 伤害。每下攻击的伤害都会递减。",
            "所有击中的目标获得 -50% 攻击，持续 4 回合。",
            "为每名盟友召唤一个鲨鱼小兵，其可从施法者处继承 20% 生命值和 20% 攻击力。对冰雪系角色造成强袭伤害。",
    ...
    },
    {
        ...
        "effects": [
            ...
            "所有被击中的目标在 6 回合内受到共计 1200 点奔涌流水伤害。（如果目标已拥有此效果，持续时间会被刷新，伤害增加 300 点。总伤害上限： 3000。）",
