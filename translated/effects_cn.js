...
[
    ...
    },
    {
        ...
        "effects": [
            ...
            "所有敌人陷入深眠，且深眠期间受到的伤害增加 +70%。（深眠中的角色无法获得法力或攻击。深眠目标受到伤害后便会苏醒。这不包括来自小兵、恶魔、超级小兵和超级恶魔的伤害。此效果无法净化）",
            "深眠目标受到伤害后便会苏醒。这不包括来自小兵和恶魔的伤害。"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            ...
            "被保镖超级小兵击中的目标陷入深眠，且深眠期间受到的伤害增加 +60%。（深眠的目标无法获得法力。深眠目标受到伤害后便会苏醒。这不包括来自小兵和恶魔的伤害。此效果无法净化）"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            ...
            "* 敌方阵型边缘的敌人陷入深眠，且深眠期间受到的伤害增加 +60%。（深眠的目标无法获得法力。深眠目标受到伤害后便会苏醒。这不包括来自小兵和恶魔的伤害。此效果无法净化）",
            "2 倍法力充能：",
            "* 驱散敌方阵型边缘敌人身上的增益。",
            "* 对位于敌军阵型边缘的敌人造成 485% 伤害。如果仅有一名敌人，则伤害加倍。",
            "* 敌方阵型边缘的敌人陷入深眠，且深眠期间受到的伤害增加 +80%。（深眠的目标无法获得法力。深眠目标受到伤害后便会苏醒。这不包括来自小兵和恶魔的伤害。此效果无法净化）",
            "3 倍法力充能：",
            "* 驱散敌方阵型边缘敌人身上的增益。",
            "* 对位于敌军阵型边缘的敌人造成 900% 伤害。如果仅有一名敌人，则伤害加倍。",
            "* 敌方阵型边缘的敌人陷入深眠，且深眠期间受到的伤害增加 +100%。（深眠的目标无法获得法力。深眠目标受到伤害后便会苏醒。这不包括来自小兵和恶魔的伤害。此效果无法净化）"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            "对所有敌人造成 180% 伤害。",
            "所有敌人陷入深眠，且深眠期间受到的伤害增加 +70%。（深眠的目标无法获得法力。深眠目标受到伤害后便会苏醒。这不包括来自小兵和恶魔的伤害。此效果无法净化）",
            "所有盟友在 4 回合内恢复 1200 点生命值。"
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            "为所有盟友恢复 32% 生命值。",
            "偷取目标的全部可驱散增益并随机施放给盟友。",
            "目标陷入深眠，且深眠期间受到的伤害增加 +50%。（深眠的目标无法获得法力。深眠目标受到伤害后便会苏醒。这不包括来自小兵和恶魔的伤害。此效果无法净化）",
    ...
    },
    {
        ...
        "effects": [
            ...
            "强化防御异常结束后、被移除或被替换后，敌人陷入深眠且深眠期间受到的伤害增加 +70%。（深眠中的角色无法获得法力或攻击。深眠目标受到伤害后便会苏醒。这不包括来自小兵、恶魔、超级小兵和超级恶魔的伤害。此效果无法净化）"
        ]
    },
    {
        "heroId": "s2_poseidon",
